...
public class GPFileDownloadAction implements Action{
	@Override
...
//		File file1 = new File(saveFolder, systemname);
//		if (file1.exists()) {
//		    long file1Size = file1.length();
//		    System.out.println("파일이 존재합니다.");
//		    System.out.println("파일 이름: " + file1.getName());
//		    System.out.println("파일 크기: " + file1Size + " bytes");
//		} else {
...
//		}
		...
		try {
			...
			System.out.println("GPFileDownloadAction : "+e);
		} finally {
			//통로들 다 닫기
			if(is != null) {
				is.close();
